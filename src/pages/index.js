...
const IndexPage = ({ data }) => (
  <Layout>
    ...
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(${configs.cover_overlay_color_rgba_to},${
          configs.cover_overlay_color_rgba_from
        ...
        <div className="container">
          ...
          <div className="appInfo">
            ...
            <div className="downloadButtonsContainer">
              <p className="appDescription">Can't wait for the app? We will notify you when it is ready.</p>
              <Form />
            </div>
          </div>
